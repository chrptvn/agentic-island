...
export default function OpenSourceCTA() {
  return (
    <section className="relative py-24 overflow-hidden">
      {/* Gradient background */}
      <div
        className="absolute inset-0 opacity-[0.05] bg-[linear-gradient(135deg,var(--color-accent-cyan),transparent_60%)]"
        aria-hidden="true"
      />
      ...
      <Container className="relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          <Button href={GITHUB_REPO_URL} size="lg" target="_blank" rel="noopener noreferrer">
            Star on GitHub
          </Button>
